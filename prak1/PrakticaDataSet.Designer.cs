...
SELECT bakery_id, bakeryName, bakeryAddress, rating FROM Bakery WHERE (bakery_id = @bakery_id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[1].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@bakeryName", global::System.Data.SqlDbType.VarChar, 100, global::System.Data.ParameterDirection.Input, 0, 0, "bakeryName", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            this._commandCollection[2] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[2].Connection = this.Connection;
            this._commandCollection[2].CommandText = "SELECT *\r\nfrom [Bakery]\r\nwhere [bakeryName] like \'%\' + @toSearch+ \'%\'";
            this._commandCollection[2].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[2].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@toSearch", global::System.Data.SqlDbType.VarChar, 100, global::System.Data.ParameterDirection.Input, 0, 0, "bakeryName", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
        }
        ...
        public virtual PrakticaDataSet.BakeryDataTable FilterByProduct(string bakeryName) {
            this.Adapter.SelectCommand = this.CommandCollection[1];
            if ((bakeryName == null)) {
                this.Adapter.SelectCommand.Parameters[0].Value = global::System.DBNull.Value;
            }
            else {
                this.Adapter.SelectCommand.Parameters[0].Value = ((string)(bakeryName));
            }
            PrakticaDataSet.BakeryDataTable dataTable = new PrakticaDataSet.BakeryDataTable();
            this.Adapter.Fill(dataTable);
            return dataTable;
...
SELECT product_id, productName, productDescription, price, bakery_id FROM Product WHERE (product_id = @product_id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[1] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[1].Connection = this.Connection;
            this._commandCollection[1].CommandText = @"select [Product].[product_id], [Product].[productName], [Product].[productDescription],
...
from [Product] inner join [Bakery] 
